...
url = "http://www.fzdmpy.com/index/introduce?id=10"

html = requests.get(url, headers=headers).text
print(html)
url_pat = re.compile(r'<a href="(.*?)" target=')
name_pat = re.compile(r'<a href=".*?" target="_self"><span style=.*?">(.*?)</span>|<a href=".*?" target="_self"><span style=.*?"><strong>(.*?)</strong></span>')
